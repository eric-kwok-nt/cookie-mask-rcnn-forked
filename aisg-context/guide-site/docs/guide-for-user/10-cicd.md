...
- `asia.gcr.io/cvhub-312105/yier/vscode-server`
- `asia.gcr.io/cvhub-312105/yier/jupyter-server`
- `asia.gcr.io/cvhub-312105/yier/data-prep`
- `asia.gcr.io/cvhub-312105/yier/model-train`
- `asia.gcr.io/cvhub-312105/yier/fastapi-server`
- `asia.gcr.io/cvhub-312105/yier/batch-inference`
- `asia.gcr.io/cvhub-312105/yier/streamlit`
    ...
    build:fastapi-server-image:
      ...
      script:
        ...
        - >-
          ...
          --destination "asia.gcr.io/${GCP_PROJECT_ID}/yier/fastapi-server:${CI_COMMIT_SHORT_SHA}"
      rules:
        - if: $CI_MERGE_REQUEST_IID
          changes:
...
=== "`.gitlab-ci.yml`"
    ...
    build:retag-images:
      ...
      script:
        ...
        - gcloud container images add-tag --quiet "asia.gcr.io/${GCP_PROJECT_ID}/yier/vscode-server:${CI_COMMIT_SHORT_SHA}" "asia.gcr.io/${GCP_PROJECT_ID}/yier/vscode-server:${CI_COMMIT_TAG}"
        - gcloud container images add-tag --quiet "asia.gcr.io/${GCP_PROJECT_ID}/yier/jupyter-server:${CI_COMMIT_SHORT_SHA}" "asia.gcr.io/${GCP_PROJECT_ID}/yier/jupyter-server:${CI_COMMIT_TAG}"
        - gcloud container images add-tag --quiet "asia.gcr.io/${GCP_PROJECT_ID}/yier/data-prep:${CI_COMMIT_SHORT_SHA}" "asia.gcr.io/${GCP_PROJECT_ID}/yier/data-prep:${CI_COMMIT_TAG}"
        - gcloud container images add-tag --quiet "asia.gcr.io/${GCP_PROJECT_ID}/yier/model-train:${CI_COMMIT_SHORT_SHA}" "asia.gcr.io/${GCP_PROJECT_ID}/yier/model-train:${CI_COMMIT_TAG}"
        - gcloud container images add-tag --quiet "asia.gcr.io/${GCP_PROJECT_ID}/yier/fastapi-server:${CI_COMMIT_SHORT_SHA}" "asia.gcr.io/${GCP_PROJECT_ID}/yier/fastapi-server:${CI_COMMIT_TAG}"
        - gcloud container images add-tag --quiet "asia.gcr.io/${GCP_PROJECT_ID}/yier/batch-inference:${CI_COMMIT_SHORT_SHA}" "asia.gcr.io/${GCP_PROJECT_ID}/yier/batch-inference:${CI_COMMIT_TAG}"
        - gcloud container images add-tag --quiet "asia.gcr.io/${GCP_PROJECT_ID}/yier/streamlit:${CI_COMMIT_SHORT_SHA}" "asia.gcr.io/${GCP_PROJECT_ID}/yier/streamlit:${CI_COMMIT_TAG}"
      rules:
