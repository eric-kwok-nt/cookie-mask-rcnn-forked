...
=== "Linux/macOS"
    ...
    $ docker build \
        -t asia.gcr.io/$GCP_PROJECT_ID/yier/data-prep:0.1.0 \
        -f docker/cookie-mask-rcnn-data-prep.Dockerfile \
        --platform linux/amd64 .
    $ docker push asia.gcr.io/$GCP_PROJECT_ID/yier/data-prep:0.1.0
    ```
...
=== "Linux/macOS"
    ...
    $ polyaxon run -f aisg-context/polyaxon/polyaxonfiles/process-data.yml \
        -P DOCKER_IMAGE="asia.gcr.io/$GCP_PROJECT_ID/yier/data-prep:0.1.0" \
...
=== "Linux/macOS"
    ...
    ```bash
    $ docker build \
        -t asia.gcr.io/$GCP_PROJECT_ID/yier/model-train:0.1.0 \
        -f docker/cookie-mask-rcnn-model-training-gpu.Dockerfile \
        --platform linux/amd64 .
    $ docker push asia.gcr.io/$GCP_PROJECT_ID/yier/model-train:0.1.0
    ```
...
=== "Linux/macOS"
    ...
    $ polyaxon run -f aisg-context/polyaxon/polyaxonfiles/train-model-gpu.yml \
        -P DOCKER_IMAGE="asia.gcr.io/$GCP_PROJECT_ID/yier/model-train:0.1.0" \
